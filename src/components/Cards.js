      ...
      <div className="card w-[23rem] m-6 max-h-full rounded-lg flex flex-col hover:scale-105 transform duration-300 shadow-2xl md:m-0 md:w-[23rem] mx-2 my-2 md:mx-4 md:my-4">
        <div className="img focus:outline-none">
          <img
            ...
            alt="Category-img"
            className="rounded-t-lg object-cover h-[20rem] w-full focus:outline-none object-top"
          />
        </div>
        <div className="text-part bg-white flex flex-col justify-between rounded-b-lg focus:outline-none">
          ...
          <a rel="noreferrer" href={props.link} className="m-3">
            <button className="bg-[#B9E6FF] text-slate-900 font-semibold rounded-lg p-2 min-w-full">
              Learn More
            </button>
          </a>
        </div>
