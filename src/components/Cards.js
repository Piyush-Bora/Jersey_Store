...
function Cards(props) {
  return (
    <>
      <div className="card max-w-[30rem] m-6 max-h-full rounded-lg flex flex-col hover:scale-105 transform duration-300 shadow-2xl md:m-0 md:w-[28rem] mx-2 my-2 md:mx-4 md:my-4">
